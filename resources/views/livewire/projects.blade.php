                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="{{ route('app.projects.show', $project->id) }}" aria-current="page"
                                            id="" data-value=""
                                            class="px-3 py-2 text-xs mr-1 font-medium text-center text-white bg-green-600 rounded hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                            View
                                            </button>
